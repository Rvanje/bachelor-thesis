...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.tabview.tab("Main").grid_columnconfigure(0, weight=1)  # configure grid of individual tabs
        self.tabview.tab("Sign In").grid_columnconfigure(0, weight=1)
        # "Sign In"-tab
        self.entry_user = customtkinter.CTkEntry(self.tabview.tab("Sign In"), placeholder_text="User")
        self.entry_user.grid(row=5, column=0, columnspan=1, padx=(10, 0), pady=(0, 0), sticky="nsew")
        self.entry_psw = customtkinter.CTkEntry(self.tabview.tab("Sign In"), placeholder_text="password")
        self.entry_psw.grid(row=6, column=0, columnspan=1, padx=(10, 0), pady=(10, 0), sticky="nsew")
        ...
        self.string_input_button.grid(row=7, column=0, padx=100, pady=(10, 10))

        # create main entry and button
        self.entry = customtkinter.CTkEntry(self.tabview.tab("Main"), placeholder_text="P Parameter")
        self.entry.grid(row=1, column=0, columnspan=1, padx=(10, 0), pady=(0, 0), sticky="nsew")
        self.entry = customtkinter.CTkEntry(self.tabview.tab("Main"), placeholder_text="I Parameter")
        self.entry.grid(row=2, column=0, columnspan=1, padx=(10, 0), pady=(5, 0), sticky="nsew")
        self.entry = customtkinter.CTkEntry(self.tabview.tab("Main"), placeholder_text="D Parameter")
        self.entry.grid(row=3, column=0, columnspan=1, padx=(10, 0), pady=(5, 0), sticky="nsew")
    ...
    def sign_in_button_event(self):
        dict_user = {"Leroy": "Harreh"}
        print(dict_user[self.entry_user.get()])
        try:
